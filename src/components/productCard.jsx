...
export default function ProductCard(props) {
    ...
    return (
        ...
        <Link to={`/overview`} className="w-[300px] h-[450px] bg-red-400 border border-gray-600 bg-white m-4 p-4 rounded-lg shadow-2xl flex flex-col items-center overflow hover:[&_.primary-image]:opacity-0 justify-between cursor-pointer">
